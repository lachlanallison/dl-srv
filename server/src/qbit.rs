...
async fn torrents_properties(
    ...
    Ok(Json(serde_json::json!({
        ...
        "comment": task.url,
        "total_wasted": 0,
        "total_uploaded": task.uploaded_bytes,
        "total_uploaded_session": task.uploaded_bytes,
        "total_downloaded": task.done_bytes,
        "total_downloaded_session": task.done_bytes,
        "up_limit": -1,
        "dl_limit": -1,
        "time_elapsed": 0,
        "nb_connections": task.connections,
        "nb_connections_limit": 100,
        "share_ratio": if task.done_bytes > 0 {
            task.uploaded_bytes as f64 / task.done_bytes as f64
        } else {
            0.0
        },
        ...
        "dl_speed": task.speed,
        "up_speed": task.upload_speed,
        "eta": 8640000,
        "last_seen": task.updated_at.timestamp(),
        "peers": task.connections,
        "peers_total": task.connections,
        "pieces_have": 0,
        "pieces_num": 0,
        "reannounce": 0,
        "seeds": task.num_seeders,
        "seeds_total": task.num_seeders,
